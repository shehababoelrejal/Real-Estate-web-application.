...
$connect = mysqli_connect("localhost","root","","real_estate");
 ...
 {  
      ...
      $query = "insert into property (photo,locationId,description,price,size,addressId) values ('$file',1,'the coolest apartment ever',1000000,400,1)";  
 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container" style="width:500px;">  
                ...
                <?php  
                $query = "SELECT * FROM property   where id > 12";  
